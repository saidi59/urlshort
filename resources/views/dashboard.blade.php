...
@section('content')
    <div class="row">
            ...
            <div class="box box-solid">
                <div class="box-body">
                    <ul class="nav nav-pills nav-stacked">
                        <li class="active"><a href="#"><i class="fa fa-inbox"></i> Visits
        ...
        <div class="col-md-9 col-xs-12">
            ...
            <button type="button" class="btn btn-primary margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#boostrapModal-1">Add Url</button>
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="has-feedback">
                            <input type="text" class="form-control input-sm" placeholder="Search Image">
